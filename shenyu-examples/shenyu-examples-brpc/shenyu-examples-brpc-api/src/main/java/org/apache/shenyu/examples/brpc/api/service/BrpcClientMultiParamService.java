 ...
 */
public interface BrpcClientMultiParamService {
     ...
     * "brpcSimpleTypeBeanList":[{"id":"123","name":"zhuangsongtao"}]}
     *
     * @param brpcComplexTypeBeanList the brpc complex type bean.
     * @param brpcSimpleTypeBeanMap            the name
     * @return BrpcSimpleTypeBean
     */
    BrpcSimpleTypeBean saveTwoList(List<BrpcComplexTypeBean> brpcComplexTypeBeanList,
                                   Map<String, BrpcSimpleTypeBean> brpcSimpleTypeBeanMap);
